...
import { useGoogleReviews, GoogleReview } from '@/lib/google-scraper';

export function GoogleReviewsScraped() {
      ...
      <section className="py-20 bg-gradient-to-b from-dark-900 to-dark-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-red-400">Erro ao carregar avaliações: {error}</p>
          </div>
        </div>
      </section>
    );
